CREATE SCHEMA Ksiegowosc; 
	...
	SELECT ksiegowosc.Pracownicy.imie, ksiegowosc.Pracownicy.nazwisko, ksiegowosc.Godziny.liczba_nadgodzin, ksiegowosc.Premia.kwota
	FROM ksiegowosc.Pracownicy
	...
	ON Wynagrodzenie.id_godziny = ksiegowosc.Godziny.id_godziny
	INNER JOIN ksiegowosc.Premia
	ON ksiegowosc.Wynagrodzenie.id_premii = ksiegowosc.Premia.id_premii
	WHERE ksiegowosc.Godziny.liczba_nadgodzin IS NOT NULL AND ksiegowosc.Premia.kwota IS NULL;
